...
namespace GameWatcher.Core.Tests
{
    public class MatchBuilderTests
    {
        private static RecordedMatch Recorded(Outcome? outcome = Outcome.IMP_WIN) => new(
            ...
            new[]
            {
                new PlayerTally("imp", "Imp", Role.IMPOSTOR, 2, 0, 0, 0, 0, true, 0, null, null),
                new PlayerTally("c1", "C1", Role.CREW, 0, 1, 0, 3, 5, true, 0, null, null),
                new PlayerTally("c2", "C2", Role.CREW, 0, 0, 1, 5, 5, false, 0, null, null),
            });
        ...
        public void Refuses_when_ended_but_endedAt_missing()
        {
            ...
            var m = new RecordedMatch("M1", "Skeld", DateTimeOffset.Parse("2026-06-27T17:00:00Z"),
                ...
                new[] { new PlayerTally("imp", "Imp", Role.IMPOSTOR, 2, 0, 0, 0, 0, true, 0, null, null) });
        ...
        public void Clamps_endedAt_before_startedAt_to_zero_duration()
        {
            var m = new RecordedMatch("M1", null,
                ...
                new[]
                {
                    new PlayerTally("imp", "Imp", Role.IMPOSTOR, 1, 0, 0, 0, 0, true, 0, null, null),
                    new PlayerTally("c1", "C1", Role.CREW, 0, 0, 0, 1, 1, true, 0, null, null),
                });
