...
public static class RankedSettings
{
    ...
    private const int TaskBarNever = 2;                    // TaskBarMode.Invisible
    private const int NumImpostors = 2;
    private const byte MapPolus = 2;                       // 0 Skeld, 1 Mira, 2 Polus, 4 Airship, 5 Fungle
    private const int KillDistShort = 0;                   // 0 short, 1 medium, 2 long
